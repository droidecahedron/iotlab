...
/********************** Includes *********************/
#include "CC3100SupportPackage/simplelink/include/simplelink.h"
#include "sl_common.h"
/********************** Includes *********************/
...
typedef enum
{
    Client = 0,
    Host = 1,
    BAD_ERROR_NO_GOOD = 666
}playerType;

/* IP addressed of server side socket.
 * Should be in long format, E.g: 0xc0a8010a == 192.168.1.10
 */
#define HOST_IP_ADDR           0xC0A80002                // IP address of server to connect to
 ...
 */
#define CONFIG_IP       SL_IPV4_VAL(192,168,0,2)       /* Static IP to be configured */
